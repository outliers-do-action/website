...
class Network_Partners_Public {
	...
	public function network_partners_post_type() {
		$labels = array(
			...
			'archives'              => __( 'Item Archives', 'network-partners' ),
			'attributes'            => __( 'Item Attributes', 'network-partners' ),
			'parent_item_colon'     => __( 'Parent Item:', 'network-partners' ),
			'all_items'             => __( 'All Items', 'network-partners' ),
			'add_new_item'          => __( 'Add New Item', 'network-partners' ),
			'add_new'               => __( 'Add New', 'network-partners' ),
			'new_item'              => __( 'New Item', 'network-partners' ),
			'edit_item'             => __( 'Edit Item', 'network-partners' ),
			'update_item'           => __( 'Update Item', 'network-partners' ),
			'view_item'             => __( 'View Item', 'network-partners' ),
			'view_items'            => __( 'View Items', 'network-partners' ),
			'search_items'          => __( 'Search Item', 'network-partners' ),
			...
			'insert_into_item'      => __( 'Insert into item', 'network-partners' ),
			'uploaded_to_this_item' => __( 'Uploaded to this item', 'network-partners' ),
			'items_list'            => __( 'Items list', 'network-partners' ),
			'items_list_navigation' => __( 'Items list navigation', 'network-partners' ),
			'filter_items_list'     => __( 'Filter items list', 'network-partners' ),
		);
		$rewrite = array(
